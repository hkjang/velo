...
public class AiPlatformApiDocsServlet extends HttpServlet {
    ...
    String buildOpenApiSpec(String requestContextPath) {
        ...
        s.append(",\n");
        apiPath(s, "/api/config/rollout-gate", "get", "Control Plane", "Get AI platform rollout gate decision", "Summarizes readiness, routing, security, observability, tenant, canary, and rollback gates.", false);
        s.append(",\n");
        ...
        s.append(",\n");
        apiPath(s, "/api/operations/rollout-gate", "get", "Control Plane", "Get rollout GO/REVIEW/BLOCK decision", "Alias of /api/config/rollout-gate.", false);
        s.append(",\n");
