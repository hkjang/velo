...
public class AiPlatformDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        b.append("<button class=\"btn btn-secondary\" onclick=\"refreshRemediationPlan()\">\uac1c\uc120 \uacc4\ud68d</button>");
        b.append("<button class=\"btn btn-secondary\" onclick=\"refreshConfigPatchBundle()\">\uc124\uc815 \ud328\uce58</button>");
        b.append("<button class=\"btn btn-secondary\" onclick=\"refreshRolloutGate()\">\ub864\uc544\uc6c3 \uac8c\uc774\ud2b8</button>");
        ...
        b.append("async function refreshRemediationPlan(){showJson('opsJson',await api('/api/config/remediation-plan'))}\n");
        b.append("async function refreshConfigPatchBundle(){showJson('opsJson',await api('/api/config/patch-bundle'))}\n");
        b.append("async function refreshRolloutGate(){showJson('opsJson',await api('/api/operations/rollout-gate'))}\n");
